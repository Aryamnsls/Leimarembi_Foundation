      ...
      >
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{ padding: '0.5rem 1.1rem', fontSize: '0.875rem', gap: '6px' }}
          >
            <Shield size={16} /> Executive Officers ({MEMBERS_DATA.filter((member) => member.category === 'Leadership').length})
          </button>
          <button
            ...
            style={{ padding: '0.5rem 1.1rem', fontSize: '0.875rem', gap: '6px' }}
          >
            <Briefcase size={16} /> Executive Members ({MEMBERS_DATA.filter((member) => member.category === 'Executive').length})
          </button>
        </div>
