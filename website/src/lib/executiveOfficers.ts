...
export const ALL_OFFICIAL_MEMBERS: OfficialMember[] = [
  ...
  },
  {
    ...
    email: "brajababu.singha@leimarembi.org",  // Email: Waiting (not yet provided) — use phone to sign in
    phone: "70862-42310",
    cleanPhone: "7086242310",
    bloodGroup: "B+",
    ageCategory: "Senior Citizen",
    passcode: "70862",
    isSeniorCitizen: true,
  ...
  },
  {
    ...
    role: "Executive Member",
    designation: "Executive Committee Member",
    email: "monimohan.singha@leimarembi.org",  // Email: Waiting (not yet provided) — use phone to sign in
    phone: "94361-18112",
    cleanPhone: "9436118112",
    bloodGroup: "B+",
    ageCategory: "Senior Citizen",
    passcode: "94361",
    isSeniorCitizen: true,
